...
@vite(['k-core/resources/css/app.css', 'k-core/resources/js/app.js'])
...
@vite(['k-core/resources/css/editor.css', 'k-core/resources/js/editor.js'])
@vite(['k-core/resources/css/emoji-picker.css', 'k-core/resources/js/emoji-picker.js'])
@vite(['k-core/resources/css/tag-input.css', 'k-core/resources/js/tag-input.js'])
@vite(['k-core/resources/css/icon-picker.css', 'k-core/resources/js/icon-picker.js'])
...
@if ($portal ?? null)
    @foreach (app(\Kopling\Core\Extension\Manager::class)->portalExtensions()->get($portal->id, collect()) as $extension)
        ...
        @if ($extension->compiledAssetsRoot)
            {!! \Kopling\Core\Extension\Manager::viteOrDist($extension->compiledAssetsRoot) !!}
        @endif
    @endforeach
@endif
